...
| <a name="input_mongos"></a> [mongos](#input\_mongos) | Configuration for mongos | <pre>object({<br/>    app_name   = optional(string, "mongos")<br/>    model_uuid = string<br/>    config     = optional(map(string), {})<br/>    channel    = optional(string, "8-transition/edge")<br/>    base       = optional(string, "ubuntu@24.04")<br/>    revision   = optional(string, null)<br/>  })</pre> | n/a | yes |

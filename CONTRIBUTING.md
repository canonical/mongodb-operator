...
Please note that all the logic of this operator is stored in a shared library hosted [here](https://github.com/canonical/mongo-single-kernel-library).
...
- Once the code has been merged on the Single Kernel repository, wait for a new version of the python package to be published, and create a PR on this repository that bumps the version of the package.
